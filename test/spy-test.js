(function (root) {
    ...
    var sinonSpy = require("../lib/spy.js");
    ...
    buster.testCase("sinon.spy", {
        ...
        "works with getters": function () {
            ...
            var spy = sinonSpy(object, "property", ["get"]);
        ...
        "works with setters": function () {
            ...
            var spy = sinonSpy(object, "test", ["set"]);
        ...
        "works with setters and getters combined": function () {
            ...
            var spy = sinonSpy(object, "test", ["get", "set"]);
        ...
        call: {
            "calls underlying function": function () {
                ...
                var spy = sinonSpy.create(function () {
                    called = true;
                });
            ...
            "retains function length 1": function () {
                var spy = sinonSpy.create(function (a) {}); // eslint-disable-line no-unused-vars

                assert.equals(spy.length, 1);
            },

            "retains function length 2": function () {
                var spy = sinonSpy.create(function (a, b) {}); // eslint-disable-line no-unused-vars

                assert.equals(spy.length, 2);
            },

            "retains function length 3": function () {
                var spy = sinonSpy.create(function (a, b, c) {}); // eslint-disable-line no-unused-vars

                assert.equals(spy.length, 3);
            },

            "retains function length 4": function () {
                var spy = sinonSpy.create(function (a, b, c, d) {}); // eslint-disable-line no-unused-vars
            ...
            "retains function length 12": function () {
                ...
                var spy = sinonSpy.create(func12Args);
        ...
        ".threw": {
            setUp: function () {
                ...
                this.spyWithTypeError = sinonSpy.create(function () {
                    throw new TypeError();
                });

                this.spyWithStringError = sinonSpy.create(function () {
                    throw "error";
                });
            },
        ...
        ".callArg": {
            ...
            "includes spy name in error message": function () {
                ...
                var spy = sinonSpy(api, "someMethod");
